<?php
    ...
    $conh = "SELECT * FROM contabilidad WHERE id = '$rid'";
    $resulth = mysqli_query($conexion, $conh) or die("Error en la consulta");
    $contabilidad = mysqli_fetch_array($resulth);
    ...
    if(isset($_POST["boton"])){
       ...
       if($ext=="pdf" || $ext=="xlsx" || $ext=="docx"){
        ...
        $editar_c = "UPDATE contabilidad SET fecha = '$fecha', informe = '$ninfo', descripcion = '$descripcion' WHERE id = '$rid'";
        mysqli_query($conexion, $editar_c) or die("no cambio informacion");
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><button onclick="window.location = 'R_Humanos.php?id=<?php echo $contabilidad['id']; ?>'" title="Editar" type="button" class="btn btn-success">
